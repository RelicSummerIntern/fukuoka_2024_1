...
<!-- page contents -->
@section('content')
	<section id="service" class="container my-4"
		style="background-color:bisque; border-radius:2%; padding-bottom:10px; max-width:550px">
		...
		<div class="container mt-5" style="width:368px;">
					...
					<div class="form-check col-12 mb-5">
						<figure class="card w-100">
							<figcaption class="card-header text-center">
								<h3 style="font-size: 14px; text-align: center; margin:0; color:rgb(95, 121, 68)">
							...
							<div class="card-body">
								<a href={{ $recipe['url'] }} class="about-description" style="text-decoration: none; color:rgb(229, 47, 183)">>>
									レシピURLはこちら</a>
							</div>
						</figure>
					</div>
